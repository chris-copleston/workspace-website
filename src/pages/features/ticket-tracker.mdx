...
excerpt: 'Say goodbye to bottlenecks and hello to productivity.  Streamline work order management with our intuitive Ticket Tracker.  Capture, track and resolve requests effortlessly while keeping everyone in the loop.'
...
import AdminServicesImage from '~/assets/images/pages/admin-services.png';
...
<div class="tablet hidden md:block relative w-full md:h-[650px] lg:h-[700px] xl:h-[700px] mx-auto">
  <Tablet
    item={{ img: AdminServicesImage.src, color: ['#ffffff'] }}
