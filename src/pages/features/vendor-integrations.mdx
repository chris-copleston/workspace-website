...
<a href="/vendors/crestron" class="btn btn-primary text-white inline-flex items-center gap-1">Crestron Integration <Icon name="tabler:chevron-right" class="w-4 h-4" /></a>
